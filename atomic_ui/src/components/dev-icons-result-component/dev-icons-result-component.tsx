...
/**
 * Dev Icon, shows an icon based upon the extension.
 *
 */
@Component({
...
export class DevIconsResultComponent {
  ...
  public render() {
    ...
    const iconlist = [
      ...
      {
        ext: ".coffee",
        icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/coffeescript/coffeescript-original-wordmark.svg",
      },
      {
        ext: ".cs",
      ...
      {
        ext: ".scala",
        icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/scala/scala-original-wordmark.svg",
      },
      {
        ext: ".scss",
        icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original-wordmark.svg",
      ...
      {
        ext: ".swift",
        icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/swift/swift-original-wordmark.svg",
      },
      {
        ext: ".tf",
    ...
    return <img part="code_image" src={icon_image} />;
  }
}
